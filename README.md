...
- **Statistics: Probability, Hypothesis Testing, Inferential Statistics
- **Machine Learning: Linear & Logistic Regression, Decision Trees, Random Forest, SVM, KNN, Naïve Bayes, Clustering, XGBoost
- **Model Optimization: GridSearchCV, RandomizedSearchCV, Cross-Validation, Feature Engineering
- **Deep Learning: CNN, ANN, Keras, Computer Vision
- **Data Visualization: Power BI, Tableau, Matplotlib
- **Tools: GitHub, MS Excel, Oracle DBA fundamentals, Built CNN-based model using Keras and TensorFlow
